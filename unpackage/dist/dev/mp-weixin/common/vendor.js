...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"build-fire","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!***********************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 30:
/*!****************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/global.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  if ((0, _typeof2.default)(time) == 'object') {
    ...
    if (!isNaN(parseFloat('time'))) {
      ...
      if (time) {
        ...
        date = (0, _construct2.default)(Date, (0, _toConsumableArray2.default)(time));
      } else {
        date = new Date(time);
      }
    }
...
/***/ 31:
/*!***************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/store/index.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = new _vuex.default.Store({
  state: {
    ...
    SYSTEMP_INFO: null,
    // 系统信息
    INVITATION_CODE: uni.getStorageSync('DH_INVITATION_CODE') ? uni.getStorageSync('DH_INVITATION_CODE') : null
  },
  getters: {
    ...
    SYSTEMP_INFO: function SYSTEMP_INFO(state) {
      return state.SYSTEMP_INFO;
    },
    INVITATION_CODE: function INVITATION_CODE(state) {
      return state.INVITATION_CODE;
    }
  },
  mutations: {
    SET_SYSTEMP_INFO: function SET_SYSTEMP_INFO(state, data) {
      state.SYSTEMP_INFO = data;
    },
    SET_INVITATION_CODE: function SET_INVITATION_CODE(state, data) {
  ...
  actions: {
    // 登录
    SET_LOGIN: function SET_LOGIN(_ref, params) {
    ...
    SET_BIND_PHONE: function SET_BIND_PHONE(_ref2, params) {
      var state = _ref2.state,
        commit = _ref2.commit,
        dispatch = _ref2.dispatch;
      return new Promise(function (resolve, reject) {
        (0, _user.setBindPhone)(params).then(function (res) {
          if (res.code == 0) {
    ...
    // 获取信息
    GET_USER: function GET_USER(_ref3, params) {
      var state = _ref3.state,
        commit = _ref3.commit,
        dispatch = _ref3.dispatch;
      return new Promise(function (resolve, reject) {
        (0, _user.getUser)(params).then(function (res) {
          if (res.code == 0) {
    ...
    // 修改信息
    SET_USER: function SET_USER(_ref4, params) {
      var state = _ref4.state,
        commit = _ref4.commit,
        dispatch = _ref4.dispatch;
      return new Promise(function (resolve, reject) {
        (0, _user.setUser)(params).then(function (res) {
          if (res.code == 0) {
            dispatch('GET_USER');
            resolve();
          } else {
    ...
    // 退出（测试使用）
    SET_LEAVE: function SET_LEAVE(_ref5) {
...
/***/ 33:
/*!************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/api/user.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.setUser = exports.setSignIn = exports.setPay = exports.setLogout = exports.setLogin = exports.setBindPhone = exports.getUser = void 0;
...
var setBindPhone = function setBindPhone(data) {
  return (0, _request.default)({
    url: "user/bindPhone",
    method: "POST",
    data: data
...
// 获取用户信息
exports.setBindPhone = setBindPhone;
...
var setPay = function setPay(data) {
  return (0, _request.default)({
    url: "order/create",
    method: "POST",
    data: data
...
var setSignIn = function setSignIn(data) {
  return (0, _request.default)({
    url: "setting/signIn",
    method: "POST",
    data: data
...
// 退出登陆
exports.setSignIn = setSignIn;
var setLogout = function setLogout(data) {
  return (0, _request.default)({
    url: "user/logout",
    method: "POST",
    data: data
...
/***/ 34:
/*!*****************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/request.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _global = _interopRequireDefault(__webpack_require__(/*! ./global.js */ 30));
var _index = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 31));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
/*
...
var request = function request() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    _ref$loadIs = _ref.loadIs,
    loadIs = _ref$loadIs === void 0 ? false : _ref$loadIs,
    _ref$errorMsgIs = _ref.errorMsgIs,
    errorMsgIs = _ref$errorMsgIs === void 0 ? true : _ref$errorMsgIs;
  // 检查网络状况
  uni.getNetworkType({
    success: function success(res) {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _global.default.baseUrl + url,
      ...
      success: function success(res) {
        ...
        if (res.statusCode == 401) {
          ...
          setTimeout(function () {
            ...
            _index.default.commit('SET_TOKEN', null);
          }, 1000);
        } else if (res.statusCode != 200) {
          showError(res);
        } else if (res.data.code != 0 && errorMsgIs) {
          //&& res.data.code != 6 res.data.code != 6为了支付提示
          uni.showToast({
            title: res.data.msg,
            icon: 'none'
          });
...
/***/ 38:
/*!****************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/upload.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var file = function file(e, params) {
  var obj = params ? params : {};
  return new Promise(function (resolve, reject) {
    uni.uploadFile({
      url: _global.default.baseUrl + 'common/upload',
      filePath: e,
      name: 'file',
      formData: _objectSpread({}, obj),
      success: function success(res) {
...
/***/ 39:
/*!***************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/share.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 40:
/*!*************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/uni.promisify.adaptor.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 401:
/*!******************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/validate.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
exports.validatorBankAccount = validatorBankAccount;
// 表单验证联系方式 电话和手机均可
function validatorTelAndPhone(params, value) {
  var s = trim(value);
  if (!s) {
    return params.require ? params.placeholder || "\u8BF7".concat(params.type == 'select' ? '选择' : '输入').concat(params.label) : '';
  } else {
    if (!/^(((\d{3,4}-)?[0-9]{7,8})|(1(3|4|5|6|7|8|9)\d{9}))$/.test(s)) {
      return "".concat(params.label, "\u683C\u5F0F\u4E0D\u6B63\u786E");
    } else {
      return '';
    }
  }
...
// 表单检验银行账号
function validatorBankAccount(params, value) {
  var s = trim(value);
  if (!s) {
    return params.require ? params.placeholder || "\u8BF7".concat(params.type == 'select' ? '选择' : '输入').concat(params.label) : '';
  } else {
...
var _default = {
  validatorTelAndPhone: validatorTelAndPhone,
  validatorBankAccount: validatorBankAccount,
  validatorIdentityCardNo: validatorIdentityCardNo
};
exports.default = _default;
...
/***/ 434:
/*!********************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/util.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _calendar = _interopRequireDefault(__webpack_require__(/*! ./calendar.js */ 435));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
  ...
  (0, _createClass2.default)(Calendar, [{
    ...
    value: function _getLastMonthDays(firstDay, full) {
      ...
      for (var i = firstDay; i > 0; i--) {
        ...
        dateArr.push({
          date: beforeDate < 10 ? '0' + beforeDate : beforeDate,
          month: full.month - 1,
    ...
    value: function _getWeek(dateData) {
      ...
      // const wds = wDays[dd.getDay()];
      // 拼接数组  上个月开始几天 + 本月天数+ 下个月开始几天
      for (var i = 0; i < canlender.length; i++) {
        if (i % 7 === 0) {
          weeks[parseInt(i / 7)] = new Array(7);
        }
        weeks[parseInt(i / 7)][i % 7] = _objectSpread(_objectSpread({}, canlender[i]), {}, {
          wds: wDays[i % 7]
        });
      }
...
/***/ 435:
/*!************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/calendar.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 436:
/*!**************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/i18n/index.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 437));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 438));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 439));
var _default = {
  en: _en.default,
...
/***/ 437:
/*!*************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/i18n/en.json ***!
  \*************************************************************************************/
...
/***/ 438:
/*!******************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/i18n/zh-Hans.json ***!
  \******************************************************************************************/
...
/***/ 439:
/*!******************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/uni-calendar/i18n/zh-Hant.json ***!
  \******************************************************************************************/
/*! exports provided: uni-calender.ok, uni-calender.cancel, uni-calender.today, uni-calender.SUN, uni-calender.MON, uni-calender.TUE, uni-calender.WED, uni-calender.THU, uni-calender.FRI, uni-calender.SAT, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"uni-calender.ok\":\"確定\",\"uni-calender.cancel\":\"取消\",\"uni-calender.today\":\"今日\",\"uni-calender.SUN\":\"周日\",\"uni-calender.MON\":\"周一\",\"uni-calender.TUE\":\"周二\",\"uni-calender.WED\":\"周三\",\"uni-calender.THU\":\"周四\",\"uni-calender.FRI\":\"周五\",\"uni-calender.SAT\":\"周六\"}");
...
/***/ 496:
/*!*************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/city-options/regions.json ***!
  \*************************************************************************************/
...
/***/ 50:
/*!**************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/api/basics.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.setShare = exports.setCreate = exports.getType = exports.getRule = exports.getList = exports.getImage = exports.getGoods = exports.getDetsils = exports.getConfig = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 34));
// 种草分类
...
var getDetsils = function getDetsils(data) {
  return (0, _request.default)({
    url: "zcao/info",
    method: "GET",
    data: data
...
// 生成文案
exports.getDetsils = getDetsils;
var setCreate = function setCreate(data) {
  return (0, _request.default)({
    url: "zcao/gpt",
    method: "POST",
    data: data,
...
var setShare = function setShare(data) {
  return (0, _request.default)({
...
var getRule = function getRule(field) {
  return (0, _request.default)({
    url: "common/rule",
    method: "GET",
    data: {
...
var getImage = function getImage(field) {
  return (0, _request.default)({
    url: "common/image",
    method: "GET",
    data: {
...
/***/ 516:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet01.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 517:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet02.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 518:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet03.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 519:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet04.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 520:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet05.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 521:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet06.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 522:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet07.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 523:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet08.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 524:
/*!**************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/static/icon/userSet09.png ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 59:
/*!******************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/utils/toBase64.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 665:
/*!****************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/u-parse/libs/MpHtmlParser.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
 ...
 * @listens MIT
 */
var cfg = __webpack_require__(/*! ./config.js */ 666),
  blankChar = cfg.blankChar,
  CssHandler = __webpack_require__(/*! ./CssHandler.js */ 667),
...
/***/ 666:
/*!**********************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/u-parse/libs/config.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 667:
/*!**************************************************************************************!*\
  !*** /Users/steveqwang/Desktop/code/BuildFire/components/u-parse/libs/CssHandler.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

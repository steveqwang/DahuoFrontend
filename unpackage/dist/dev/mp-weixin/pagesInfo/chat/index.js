...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pagesInfo/chat/index.vue */ 233));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_43e7bb86_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=43e7bb86&scoped=true& */ 234);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_43e7bb86_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=43e7bb86&lang=scss&scoped=true& */ 240);
...
var Recording = function Recording() {
  __webpack_require__.e(/*! require.ensure | pagesInfo/chat/recording */ "pagesInfo/chat/recording").then((function () {
    return resolve(__webpack_require__(/*! ./recording.vue */ 626));
...
var chatPopup = function chatPopup() {
  __webpack_require__.e(/*! require.ensure | pagesInfo/chat/chat-popup */ "pagesInfo/chat/chat-popup").then((function () {
    return resolve(__webpack_require__(/*! ./chat-popup.vue */ 640));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var _default = {
  components: {
  ...
  data: function data() {
    return {
      ...
      pageSize: 30,
      funcList: [{
        image: __webpack_require__(/*! ../static/icon/xiangce.png */ 238),
        name: '照片',
        type: 'album'
      }, {
        image: __webpack_require__(/*! ../static/icon/paizhao.png */ 239),
        name: '拍摄',
        type: 'camera'
      }],
      news: {
...
},[[232,"common/runtime","common/vendor","pagesInfo/common/vendor"]]]);
